...
public class EmrpesasMentira {
   ...
   static ArrayList<Empresa> listaEmpresas = new ArrayList<>();
    public EmrpesasMentira(){
        ...
        Empresa empresa1 = new Empresa("1","Empresa1","600001",15,"Coso");
        Empresa empresa2 = new Empresa("2","Empresa2","600002",20,"Coso");
        Empresa empresa3 = new Empresa("3","Empresa3","600003",50,"Tecno");
